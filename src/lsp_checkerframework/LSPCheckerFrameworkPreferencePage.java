...
//				.getDefaultBoolean("BOOLEAN 1")); //$NON-NLS-1$
//		checkBox2.setSelection(store
//				.getDefaultBoolean("BOOLEAN 2")); //$NON-NLS-1$
//		checkBox3.setSelection(store
//				.getDefaultBoolean("BOOLEAN 3")); //$NON-NLS-1$
//
//		radioButton1.setSelection(false);
//		radioButton2.setSelection(false);
//		radioButton3.setSelection(false);
//		int choice = store.getDefaultInt("CHOICE"); //$NON-NLS-1$
//		switch (choice) {
//		case 1:
...
//			break;
//		}
//		textField.setText(store.getDefaultString("TEXT")); //$NON-NLS-1$
//	}
//
//	/**
//	 * Initializes states of the controls from the preference store.
...
//	private void initializeValues() {
//		IPreferenceStore store = getPreferenceStore();
//		checkBox1.setSelection(store.getBoolean("BOOLEAN 1")); //$NON-NLS-1$
//		checkBox2.setSelection(store.getBoolean("BOOLEAN 2")); //$NON-NLS-1$
//		checkBox3.setSelection(store.getBoolean("BOOLEAN 3")); //$NON-NLS-1$
//
//		int choice = store.getInt("CHOICE"); //$NON-NLS-1$
//		switch (choice) {
//		case 1:
//			radioButton1.setSelection(true);
//			break;
...
//			break;
//		}
//		textField.setText(store.getString("TEXT")); //$NON-NLS-1$
//	}
//
//	/** (non-Javadoc)
//	 * Method declared on ModifyListener
...
//	private void storeValues() {
//		IPreferenceStore store = getPreferenceStore();
//		store.setValue("BOOLEAN 1", checkBox1.getSelection()); //$NON-NLS-1$
//		store.setValue("BOOLEAN 2", checkBox2.getSelection()); //$NON-NLS-1$
//		store.setValue("BOOLEAN 3", checkBox3.getSelection()); //$NON-NLS-1$
//
//		int choice = 1;
//
...
//			choice = 3;
//
//		store.setValue("CHOCIE", choice); //$NON-NLS-1$
//		store.setValue("TEXT", textField.getText()); //$NON-NLS-1$
//	}
//
//	/**
